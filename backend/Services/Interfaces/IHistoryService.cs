...
namespace WebTestUI.Backend.Services.Interfaces
{
    public interface IHistoryService
    {
        ...
        Task<IEnumerable<HistoryDto>> GetRequestHistoryAsync(int requestId, string userId); // Eklendi
        ...
        Task<int> ClearOldHistoryAsync(string userId, DateTime olderThan); // Eklendi
    }
}
