...
namespace WebTestUI.Backend.Services.Interfaces
{
    ...
    {
        Task<IEnumerable<RequestDto>> GetUserRequestsAsync(string userId, string? currentEnvironmentId);
        ...
        Task<IEnumerable<RequestDto>> GetCollectionRequestsAsync(int collectionId, string userId, string? currentEnvironmentId);
    }
}
