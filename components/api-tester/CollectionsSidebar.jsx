    ...
    <div className="h-full flex flex-col border-r bg-white dark:bg-gray-950 border-gray-200 dark:border-gray-800">
      <div className="p-4 border-b border-gray-200 dark:border-gray-800">
        ...
        <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
          ...
          <DialogContent aria-describedby="collection-dialog-description">
            <DialogHeader>
              <DialogTitle>Add New Collection</DialogTitle>
              <DialogDescription id="collection-dialog-description">
  ...
  return (
    <AccordionItem value={collection._id} className="border-b-0 mb-1">
      <div className="flex items-center">
        <AccordionTrigger
          className="flex-1 flex justify-between items-center w-full hover:bg-gray-100 dark:hover:bg-gray-800 px-2 py-1.5 rounded text-sm font-medium text-left [&[data-state=open]>span>svg:last-child]:rotate-90"
        >
        ...
        <div 
          className="px-2 py-1.5 cursor-pointer hover:text-red-500"
          onClick={(e) => {
            e.stopPropagation();
      ...
      <AccordionContent className="pl-6 pr-2 pt-1 pb-1">
        {!requests && <p className="text-xs text-red-500 py-1 px-2">Error loading requests</p>}
        ...
        {requests && requests.map((request) => {
          ...
          return (
            ...
            >
              ...
              <div 
                className="h-6 w-6 opacity-0 group-hover:opacity-100 hover:text-red-500 flex items-center justify-center cursor-pointer"
                onClick={(e) => {
                  e.stopPropagation();
