...
function NotificationsModal({ open, setOpen, darkMode }) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent 
        className={`w-[95%] sm:max-w-md md:max-w-lg lg:max-w-xl max-h-[90vh] overflow-hidden flex flex-col ${
        ...
        <Tabs defaultValue="notifications" className="w-full h-full flex flex-col">
          <DialogHeader className="px-3 sm:px-6 py-3 sm:py-4 border-b border-gray-200 shrink-0">
            <div className="flex items-center justify-between">
              ...
              <TabsList className="grid w-full max-w-[250px] sm:max-w-none grid-cols-2">
                <TabsTrigger value="notifications" className="flex items-center text-xs sm:text-sm">
                  <Bell className="h-3 w-3 sm:h-4 sm:w-4 mr-1 sm:mr-2" /> 
                  Notifications
                  {unreadCount > 0 && (
                    <Badge variant="destructive" className="ml-1 sm:ml-2 h-4 sm:h-5 w-4 sm:w-5 p-0 text-xs flex items-center justify-center rounded-full">
                      {unreadCount}
                    </Badge>
                  )}
                </TabsTrigger>
                <TabsTrigger value="preferences" className="flex items-center text-xs sm:text-sm">
                  <Settings className="h-3 w-3 sm:h-4 sm:w-4 mr-1 sm:mr-2" /> Preferences
                </TabsTrigger>
              </TabsList>
          ...
          <TabsContent value="notifications" className="flex-1 overflow-y-auto p-0">
            <div className="flex items-center justify-between p-2 sm:p-4 border-b">
              ...
              <Button 
                ...
                className="text-xs flex items-center px-2 sm:px-3 h-7 sm:h-8"
              >
            ...
            {isLoading ? (
                ...
                {notifications
                  ...
                  .map(notification => (
                    <div key={notification.id} 
                      className={`p-3 sm:p-4 flex ${!notification.isRead ? 'bg-blue-50 dark:bg-blue-900/20' : ''}`}
                    >
              ...
              <div className="flex flex-col items-center justify-center p-6 sm:p-12 text-center">
                <Bell className="h-8 w-8 sm:h-12 sm:w-12 text-gray-300 mb-2 sm:mb-3" />
          ...
          <TabsContent value="preferences" className="flex-1 overflow-y-auto p-3 sm:p-6">
            <div className="space-y-4 sm:space-y-6 max-h-[50vh] sm:max-h-[60vh] overflow-y-auto pr-2 custom-scrollbar">
              ...
              <div>
                ...
                <div className="space-y-3 sm:space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="pr-2">
                      <Label htmlFor="api-updates" className="font-medium text-xs sm:text-sm">API Updates</Label>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="pr-2">
                      <Label htmlFor="request-errors" className="font-medium text-xs sm:text-sm">Request Errors</Label>
                      <p className="text-[10px] sm:text-xs text-gray-500">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="pr-2">
                      <Label htmlFor="test-failures" className="font-medium text-xs sm:text-sm">Test Failures</Label>
                      <p className="text-[10px] sm:text-xs text-gray-500">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="pr-2">
                      <Label htmlFor="team-mentions" className="font-medium text-xs sm:text-sm">
                        <span className="flex items-center">
                          <AtSign className="h-3 w-3 sm:h-4 sm:w-4 mr-1" /> Mentions
                        </span>
                      </Label>
                      <p className="text-[10px] sm:text-xs text-gray-500">
              ...
              <div>
                ...
                <div className="space-y-3 sm:space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="pr-2">
                      <Label htmlFor="email-comments" className="font-medium text-xs sm:text-sm">Comments</Label>
                      <p className="text-[10px] sm:text-xs text-gray-500">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="pr-2">
                      <Label htmlFor="email-shared" className="font-medium text-xs sm:text-sm">Shared APIs</Label>
                      <p className="text-[10px] sm:text-xs text-gray-500">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="pr-2">
                      <Label htmlFor="email-security" className="font-medium text-xs sm:text-sm">Security Alerts</Label>
                      <p className="text-[10px] sm:text-xs text-gray-500">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="pr-2">
                      <Label htmlFor="newsletter" className="font-medium text-xs sm:text-sm">Newsletter</Label>
                      <p className="text-[10px] sm:text-xs text-gray-500">
              ...
              <div>
                ...
                <div className="space-y-3 sm:space-y-4">
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      <div className="pr-2">
                        <Label htmlFor="slack-notify" className="font-medium text-xs sm:text-sm">Slack</Label>
                        <p className="text-[10px] sm:text-xs text-gray-500">
                    ...
                    {localPreferences.slackEnabled && (
                      <div className="pt-1 sm:pt-2 space-y-2">
                        <div>
                          <Label htmlFor="slack-webhook" className="text-[10px] sm:text-xs">Webhook URL</Label>
                          <Input 
                            id="slack-webhook"
                            value={localPreferences.slackWebhookUrl || ''}
                            onChange={(e) => handleInputChange('slackWebhookUrl', e.target.value)}
                            placeholder="https://hooks.slack.com/services/..."
                            className="mt-1 text-xs sm:text-sm h-7 sm:h-9"
                          />
                        </div>
                        <div>
                          <Label htmlFor="slack-channel" className="text-[10px] sm:text-xs">Channel</Label>
                          <Input 
                            id="slack-channel"
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      <div className="pr-2">
                        <Label htmlFor="discord-notify" className="font-medium text-xs sm:text-sm">Discord</Label>
                        <p className="text-[10px] sm:text-xs text-gray-500">
                    ...
                    {localPreferences.discordEnabled && (
                      <div className="pt-1 sm:pt-2">
                        <Label htmlFor="discord-webhook" className="text-[10px] sm:text-xs">Webhook URL</Label>
                        <Input 
                          id="discord-webhook"
            ...
            <DialogFooter className="mt-4 sm:mt-6 flex-col sm:flex-row gap-2 sm:gap-0 sticky bottom-0 pb-2 pt-2 bg-inherit border-t">
              ...
              >
                <RefreshCw className="h-3 w-3 sm:h-4 sm:w-4 mr-1" /> Reset to Default
              </Button>
              <Button 
