    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      ...
      <DialogContent className="sm:max-w-md max-h-[90vh] overflow-y-auto p-0 w-[95%] mx-auto">
        <div className="relative overflow-hidden rounded-lg">
          ...
          <div className="absolute -top-20 -left-20 w-40 h-40 bg-blue-500/10 rounded-xl rotate-12 animate-float opacity-50"></div>
          <div className="absolute top-40 -right-16 w-32 h-32 bg-cyan-500/10 rounded-xl -rotate-12 animate-float-delayed opacity-50"></div>
          <div className="absolute -bottom-16 -left-10 w-24 h-24 bg-indigo-500/10 rounded-xl rotate-45 animate-float-slow opacity-50"></div>
              ...
              <div>
                ...
                <div className="relative mt-1">
                  <Input
                    ...
                    className={`w-full pl-10 pr-4 py-2 sm:py-3 ${errors.fullName ? 'border-red-500 focus:ring-red-500' : 'border-gray-200'}`}
              ...
              <div>
                ...
                <div className="relative mt-1">
                  <Input
                    ...
                    className={`w-full pl-10 pr-4 py-2 sm:py-3 ${errors.email ? 'border-red-500 focus:ring-red-500' : 'border-gray-200'}`}
              ...
              <div>
                ...
                <div className="relative mt-1">
                  <Input
                    ...
                    className={`w-full pl-10 pr-4 py-2 sm:py-3 ${errors.password ? 'border-red-500 focus:ring-red-500' : 'border-gray-200'}`}
                    placeholder="••••••••"
                  />
              ...
              <div>
                ...
                <div className="relative mt-1">
                  <Input
                    ...
                    className={`w-full pl-10 pr-4 py-2 sm:py-3 ${errors.confirmPassword ? 'border-red-500 focus:ring-red-500' : 'border-gray-200'}`}
                    placeholder="••••••••"
                  />
                  <Lock className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-gray-400" />
                </div>
